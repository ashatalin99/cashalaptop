...
const FullHero = () => {
  return (
    <section className="relative bg-[url(/hero-min.jpg)] py-40 after:content-[''] after:absolute after:inset-0 after:bg-[#222]/90">
      <div className="container mx-auto px-4 relative z-10">
        <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-[3.25rem] font-bold text-white text-center leading-tight uppercase">
            ...
            electronics <em className="font-light lowercase">for </em><span className="text-[#56C3E0] font-light uppercase">cash</span>
        </h1>
