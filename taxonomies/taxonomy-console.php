<?php
// Create category brands for console
add_action('init', function() {
    register_taxonomy('console_brand', ['console'], [
        'label' => 'Brands',
        'hierarchical' => true,
        'public' => true,
        'show_admin_column' => true,
        'show_in_graphql'       => true,
        'graphql_single_name'   => 'ConsoleBrand',
...
add_action('save_post_console', function($post_id) {
    ...
    if ($post->post_name !== $new_slug) {
        ...
        add_action('save_post_console', __FUNCTION__);
    }
});
